# Tier 0 Normative Semantics (Authoritative)

This section defines the **irreversible semantic foundation** of the *irix* ecosystem.  
All semantics documented here are **frozen from v0.1.0 onward**.

No higher-tier crate may reinterpret, relax, or silently override these meanings.
...
### 1.5 Image Axes Meaning
- Images are conceptually indexed as `(y, x, c)`:
...
- All semantics in this document are **frozen from v0.1.0**.
- Future releases may:
  - add new semantic types
  - add new markers
- Future releases may **not**:
  - reinterpret existing semantics
  - weaken invariants
  - change coordinate or layout meaning

Any deviation constitutes a breaking semantic change.
